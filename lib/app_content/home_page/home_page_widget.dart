                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed('formplaintiff');
                                        },
                                        text: 'Create a New ',
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowRadioButton(
                                options:
                                    ['Ongoing Cases', 'Past Cases'].toList(),
                                onChanged: (val) => setState(() {}),
                                controller: _model.caseRadioValueController ??=
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<CasesubRecord>>(
                                    stream: _model.casequery(
                                      requestFn: () => queryCasesubRecord(),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewCasesubRecordList.length,
                        ...
                        if (_model.caseRadioValue == 'Past Cases')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 10.0),
                            child: Container(
